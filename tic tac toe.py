...
def game_X():
    ...
    elif ((gm_list[0][0])=='X' or (gm_list[0][0])=='O') and ((gm_list[0][1])=='X' or (gm_list[0][1])=='O') and ((gm_list[0][2])=='X' or (gm_list[0][2])=='O') and ((gm_list[1][0])=='X' or (gm_list[1][0])=='O') and ((gm_list[1][1])=='X' or (gm_list[1][1])=='O') and ((gm_list[1][2])=='X' or (gm_list[1][2])=='O') and ((gm_list[2][0])=='X' or (gm_list[2][0])=='O') and ((gm_list[2][1])=='X' or (gm_list[2][1])=='O') and ((gm_list[2][2])=='X' or (gm_list[2][2])=='O'):
        print("\n **All space are occupied**\n\t***Noone wins!!****")
        exit()
